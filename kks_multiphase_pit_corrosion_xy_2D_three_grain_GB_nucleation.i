...
[Materials]
 ...
 # Chemical free energy of the matrix
  ...
  [./gamma]
    ...
    f_name = gamma
    args = 'gr0 gr1 gr2'
    function = '4*zeta/theta_ref*(1-log(zeta/theta_ref))'
  ...
  [./constants1]
    ...
    type = GenericFunctionMaterial  
    prop_names  = 'Ref_D1 Ref_D2 Ref_D3  L  kappa  omega  mu  kbT'   # mu = 3*omega
