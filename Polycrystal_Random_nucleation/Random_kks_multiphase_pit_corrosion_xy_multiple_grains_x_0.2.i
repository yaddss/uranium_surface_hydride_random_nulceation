...
[UserObjects]
  ...
  [exo_variables]
    ...
    mesh = 'Random_kks_multiphase_pit_corrosion_xy_multiple_grains_0_out.e'
...
[Materials]
 ...
 # Chemical free energy of the matrix
  ...
  [./el_driving_force_eta2]
    type = DerivativeParsedMaterial
    args = 'eta1 eta2 eta3 c1 c2 c3 stress_11 stress_12 stress_22 gr0 gr1 gr2 gr3 gr4 gr5 in_stress_11 in_stress_12 in_stress_22'
    f_name = deltaG_el_eta2
    function = '-(stress_11+40)*(gr0*gr0_eih11+gr1*gr1_eih11+gr2*gr2_eih11+gr3*gr3_eih11+gr4*gr4_eih11+gr5*gr5_eih11)-(stress_22)*(gr0*gr0_eih22+gr1*gr1_eih22+gr2*gr2_eih22+gr3*gr3_eih22+gr4*gr4_eih22+gr5*gr5_eih22)-2*(stress_12)*(gr0*gr0_eih12+gr1*gr1_eih12+gr2*gr2_eih12+gr3*gr3_eih12+gr4*gr4_eih12+gr5*gr5_eih12)'
  ...
  [./eigen_bar]
    type = GenericConstantRankTwoTensor
    tensor_values = '0.2 0 0 0 0 0'   #ei11,ei22,ei33,ei23,ei13,ei12  
