...
[Functions]
  ...
  [./ic_fun_gr0]
    type = ParsedFunction
    value = '0.5*(1.0+tanh(-2.0*alpha/gb_width*(x)))'
    vars = 'alpha gb_width '
    vals = '2.0    24.0  '
  [../]
  [./ic_fun_gr1]
    type = ParsedFunction
    value = '1-0.5*(1.0+tanh(-2.0*alpha/gb_width*(x)))'
    vars = 'alpha gb_width'
    vals = '2.0    24.0 '
  [../]
  ...
  # [./ic_fun_eta1]
    # type = ParsedFunction
    # value = '1-0.5*(1.0+tanh(-2.0*alpha/lambda*sqrt((x)^2+(y)^2)+alpha+alpha*2.0*r/lambda))'
    # vars = 'alpha lambda r'
    # vals = '2.0  6.0  7.0'
  # [../]
  # [./ic_fun_eta2]
    # type = ParsedFunction
    # value = '0.5*(1.0+tanh(-2.0*alpha/lambda*sqrt((x)^2+(y)^2)+alpha+alpha*2.0*r/lambda))'
    # vars = 'alpha lambda r'
    # vals = '2.0  6.0  7.0'
  # [../]
  # [./ic_fun_c]
    # type = ParsedFunction
    # value = '(c_ppt+c_mat)/2.0+(c_ppt-c_mat)/2.0*tanh(-2.0*alpha/lambda*sqrt((x)^2+(y)^2)+alpha+alpha*2.0*r/lambda)'
    # vars = 'c_ppt  c_mat  alpha lambda r'
    # vals = '0.75    0.04     2.0    6.0   7.0'
  # []
[]
...
[Materials]
 ...
 # Chemical free energy of the matrix
  ...
  [./f_sg_mat]
    ...
    f_name = f_sg_mat
    args = 'gr0 gr1 gr2 c'
    function = '-p0*c*((-0.5*gr0^2+0.25*gr0^4)+(-0.5*gr1^2+0.25*gr1^4)+(-0.5*gr2^2+0.25*gr2^4)+gamma*(gr0^2*gr1^2+gr0^2*gr2^2+gr1^2*gr2^2)+0.25)'
  ...
  [./zeta]
    ...
    f_name = zeta
    args = 'gr0 gr1 gr2'
    function = '(gr0^2*gr1^2*theta01+gr0^2*gr2^2*theta02+gr1^2*gr2^2*theta12)/(gr0^2*gr1^2+gr0^2*gr2^2+gr1^2*gr2^2)'
    material_property_names = 'theta01 theta02 theta12'
	outputs = exodus
  [../]
  # constant properties
  [./constants_gr]
    type = GenericFunctionMaterial  
    prop_names  = 'theta01 theta02 theta12 theta_ref p0'   # p0 = 1*omega
    prop_values = '2.5
	               7.5
				   5
				   15
				   0*24*60/3e-8*8e+15/(2e+8)^3*1'  
  [../]
  ...
  [./constants1]
    ...
    type = GenericFunctionMaterial  
    prop_names  = 'Ref_D1 Ref_D2 Ref_D3 D_GB L  kappa  omega  mu  kbT'   # mu = 3*omega
  ...
  [./constants2]
    type = GenericFunctionMaterial  
    prop_names  = 'gr0_eih11  gr0_eih22  gr0_eih12  gr0_eio11 gr0_eio22 gr0_eio12  gr1_eih11 gr1_eih22 gr1_eih12 gr1_eio11 gr1_eio22 gr1_eio12   gr2_eih11 gr2_eih22 gr2_eih12 gr2_eio11 gr2_eio22 gr2_eio12'   
    prop_values = '0.1259     0.1259     0          0.0145    0.0145    0          0.1259    0.1259    0         0.0145    0.0145    0           0.1259    0.1259    0         0.0145    0.0145    0' 
  [../]
  ...
  [./Mobility_Msgr0]
    ...
    args = 'c c1 c2 c3 eta1 eta2 eta3 gr0 gr1 gr2'
  ...
  [./h1_gr0]
    type = DerivativeParsedMaterial
    f_name = h1_gr0
    args = 'eta1 eta2 eta3 gr0 gr1 gr2'
  ...
  [./D]
    type = ParsedMaterial
    material_property_names = 'Ref_D1 Ref_D2 Ref_D3 h1 h2 h3'
    function = Ref_D1*h1+Ref_D2*h2+Ref_D3*h3
    f_name = D
	args = 'gr0 gr1 gr2 eta1 eta2 eta3'
	outputs = exodus
  [../]
  ...
  [./el_driving_force_eta2]
    type = DerivativeParsedMaterial
    args = 'eta1 eta2 eta3 c1 c2 c3 stress_11 stress_12 stress_22 gr0 gr1 gr2'
    f_name = deltaG_el_eta2
    function = '-stress_11*(gr0*gr0_eih11+gr1*gr1_eih11+gr2*gr2_eih11)-stress_22*(gr0*gr0_eih22+gr1*gr1_eih22+gr2*gr2_eih22)-2*stress_12*(gr0*gr0_eih12+gr1*gr1_eih12+gr2*gr2_eih12)'
    material_property_names = 'gr0_eih11 gr0_eih22 gr0_eih12 gr1_eih11 gr1_eih22 gr1_eih12 gr2_eih11 gr2_eih22 gr2_eih12'
  [../]
  [./tot_driving_force_eta2]
    type = DerivativeParsedMaterial
    f_name = deltaG_eta2
  ...
  [./C]
    ...
    args = 'eta1 eta2 eta3 gr0 gr1 gr2'
    tensors = 'C_matrix_gr0   C_precipitate_gr0  C_carbide_gr0   C_matrix_gr1   C_precipitate_gr1  C_carbide_gr1 C_matrix_gr2   C_precipitate_gr2  C_carbide_gr2'
    weights = 'h1_gr0  h2_gr0  h3_gr0   h1_gr1   h2_gr1   h3_gr1  h1_gr2   h2_gr2   h3_gr2'
  [../]
  [./stress]
  ...
  [./eigen_bar]
    type = GenericConstantRankTwoTensor
    tensor_values = '0.1 0 0 0 0 0'   #ei11,ei22,ei33,ei23,ei13,ei12  
    tensor_name = eigen_bar
  [../]
  [./composite_eigenstrain]
    type = CompositeEigenstrain
    tensors ='eigen_precipitate_gr0 eigen_precipitate_gr1 eigen_precipitate_gr2 eigen_carbide_gr0 eigen_carbide_gr1 eigen_carbide_gr2 eigen_bar'
    weights = 'h2_gr0 h2_gr1 h2_gr2 h3_gr0 h3_gr1 h3_gr2 bar'
    args = 'eta1 eta2 eta3 gr0 gr1 gr2'
...
[Executioner]
  ...
  nl_max_its = 10      #default 50
  
  l_tol = 1e-4         #default 1e-05
  nl_abs_tol = 5e-05   #default 1e-50
...
# [Adaptivity]
  ...
  # [./Markers]
    ...
    # [./combo]
      # type = ComboMarker
      # markers = 'nuc grad grad_gr0 grad_gr1 grad_gr2' #  
    # [../]
  # [../]
  # marker = combo
  # cycles_per_step = 3
